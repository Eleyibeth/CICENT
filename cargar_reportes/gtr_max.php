                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Cargar Información GTR-MAX </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                            ...
                            <li class="active">
                                <small><i class="fa fa-file-excel-o fa-2x"></i></small> GTR-MAX
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="container-fluid">
                    ...
                    <div class="container-fluid row">
                        ...
                        <form action="" method="">
                            ...
                            <div class="col-md-12">
                                <input type="image"  name="" src="../img/amarillo.jpg" alt="logo_upload_scli" class="img-circle img-responsive center-block">
