...
class Alarma {
    ...
    //Metodo que validad la existencia del chuto.
    public function validar_chuto() {

    	global $database;

    	$sql = "SELECT id_chuto FROM chuto WHERE placa_chuto='" . $database->escape_string($this->pla_veh) . "'";
    ...
    //Una vez exista el chuto se le asigna la alarma.
    public function alarma_chuto() {
