				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-6">
								<a href="register.php" class="active"></a>
							</div>
						</div>
						<hr>
					</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<form action="" id="register-form" method="post" role="form">
						...
						<div class="form-group">
							<input type="password" name="confirm-password" id="confirm-password" tabindex="1" class="form-control" placeholder="Confirm Password" required>
						</div>
						<div class="form-group">
							<div class="row">
