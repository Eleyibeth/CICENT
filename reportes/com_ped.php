            ...
            <div class="container-fluid">
                ...
                <br>
                    <div class="row">
                        ...
                        <div class="dropdown col-md-3">
                            <input type="checkbox" name="vehicle" value="Bike"> Estrategicos<br>
                            <input type="checkbox" name="vehicle" value="Car" checked> Críticos
                        </div>
                        <div class="dropdown col-md-2">
                          <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            Planta
                        ...
                        <div class="dropdown col-md-3">
                            <input type="checkbox" name="vehicle" value="Bike"> Sin Cargar<br>
                            <input type="checkbox" name="vehicle" value="Car" checked> Por Cerrar
                        </div>
                    </div>
                <br>
                <div class="row">
                    <div class="table-responsive">
                        <table class="table table-bordered  table-condensed table-hover text-center">
                            <tr style="background-color: #FF0000; color: #FFF;">
                                ...
                                <th colspan="4">Comportamiento de pedidos por dia ( Prog / Desp)</td>
                                <th colspan="3">Pedidos Prog / Desp</th>
                                <th colspan="2">Comportamiento ultimos 5 dias</th>
                            </tr>
                            <tr style="background-color: #FF0000; color: #FFF;">
                                <th>f1</th>
                                <th>f2</th>
