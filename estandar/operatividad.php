            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <h1 class="page-header">
                            ...
                            <small>Estatus de Unidades en Talleres Externos DTTO Andes<small> ___________________________________________________</small> <small> <a href="../estandar/actualizar_operatividad.php" class="btn btn-danger active"> Actualizar</a> </small></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="container-fluid">
                    <center>
                        <div class="row">        
                            <div class="col-lg-5">
                                <label for="fecha"> Actualizado:</label>
                            ...
                            <div class="col-md-3">
                                <button type="" class="btn btn-danger active"> Borrar Data </button>
                            </div>
